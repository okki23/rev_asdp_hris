...
<link rel="stylesheet" type="text/css" href="<?php echo base_url();?>assets/themes/default/easyui.css">
	...
	<script type="text/javascript" src="<?php echo base_url();?>assets/datagrid-filter.js"></script>
...
<div class="easyui-layout" data-options="fit:true,border:false" >
	...
	<div data-options="region:'west',split:false,hideCollapsedContent:false,singleSelect:true" collapsed="false" title="History" style="width:50%;">

 



    <table id="tbl" class="easyui-datagrid" data-options="fit:true,border:false" fitColumns="false" singleSelect="true" url="<?php echo base_url();?>data_pribadi/get_all_data_pribadi_json/<?php echo $personnel_id;?>" toolbar="#toolbar" pagination="true" rownumbers="true" fitColumns="true" singleSelect="true" >

		<thead>
			<tr>
				<th field="start_date" width="70">From</th>
				<th field="end_date" width="70">To</th>
				<th field="name_full" width="150">Nama Lengkap</th>
				<th field="gender" width="80">Gender</th>
				<th field="birth_date" width="80">Tanggal Lahir</th>
				<th field="religion" width="60">Agama</th>
				<th field="marital_status" width="100">Status Pernikahan</th>
