            ...
            <legend>Key Data</legend>
              <table cellpadding="5">
                <tr>
                    <td>Periode :</td>
                    <td></td> 
                    <td><input class="easyui-datebox" type="text" name="start_date" style="width:100%;" value="<?php echo $date_start_today;?>" ></input></td>
                    <td></td>
            ...
            <legend> Personal Data</legend>
             <table cellpadding="5">
                ...
                <tr>
                    ...
                    <td>Tanggal : </td>
                    <td> <input name="birth_date" class="easyui-datebox" data-options="formatter:myformatter" style="width:100%;"> </td>
                    <td colspan="2"> &nbsp; </td>
                ...
                <tr>
                    ...
                    <td> Sejak : </td>
                    <td> <input name="status_since" class="easyui-datebox" data-options="formatter:myformatter" style="width:100%;"> </td>
                    <td> &nbsp; </td> 
