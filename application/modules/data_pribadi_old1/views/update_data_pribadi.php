            ...
            <legend>Key Data </legend>
              <table cellpadding="5">
                <tr>
                    <td>Peride  </td>
                    <td></td> 
                    <td><input class="easyui-datebox" data-options="formatter:myformatter" type="text" name="start_date" style="width:100%;" value="<?php echo $start_date; ?>" ></input></td>
                    <td></td>
                    <td><input class="easyui-datebox" data-options="formatter:myformatter"  type="text" name="end_date" style="width:100%;" value="<?php echo $end_date; ?>"></input></td>
                    <td>Status</input></td>
                    <td>
            ...
            <legend> Personal Data</legend>
             <table cellpadding="5">
                ...
                <tr>
                    ...
                    <td> Sejak : </td>
                    <td> <input name="status_since" class="easyui-datebox" data-options="formatter:myformatter" value="<?php echo $status_since; ?>" style="width:100%;"> </td>
                    <td> &nbsp; </td> 
