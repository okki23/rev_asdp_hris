...
<div class="easyui-layout" data-options="fit:true,border:false" >
    ...
    <table id="tbl" class="easyui-datagrid" data-options="fit:true,border:false" 
			url="<?php echo base_url();?>data_pribadi/get_all_data_pribadi_json/<?php echo $personnel_id;?>"
			toolbar="#toolbar" pagination="true"
			rownumbers="true" fitColumns="true" singleSelect="true" >
		<thead>
			<tr>
				<th field="personnel_id" width="30">From</th>
				<th field="personnel_id" width="20">To</th>
				<th field="personnel_id" width="30">Nama Lengkap</th>
				<th field="personnel_id" width="20">Gender</th>
				<th field="personnel_id" width="10">Tanggal Lahir</th>
				<th field="personnel_id" width="10">Agama</th>
				<th field="personnel_id" width="10">Status Pernikahan</th>
	...
	<div id="toolbar">
		...
		<a href="javascript:void(0)" class="easyui-linkbutton" iconCls="icon-add" plain="true" onclick="getTab('New History','<?php echo base_url();?>data_pribadi/data_pribadi_update_selected')">  New  </a>
