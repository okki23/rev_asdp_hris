...
*/
	...
	public function get_all_data_pribadi_json(){
		$data_employee = $this->model_data_pribadi->get_all_data_pribadi_json();
		echo json_encode($this->model_data_pribadi->get_all_data_pribadi_json());
	}
	...
	public function index()	{
		...
		$error = '';
		$data_employee = $this->model_data_pribadi->get_all_data_pribadi();
	...
	public function data_pribadi_detail(){
		$id = $this->uri->segment(3);
	 	...
	 	$this->load->view('data_pribadi/data_pribadi_update',$data);
	}
