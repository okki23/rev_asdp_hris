...
*/
	...
	public function get_all_data_pribadi(){
 
	$query = $this->db->query("select *,case when gender = '1' then 'Pria' else 'Wanita' end as gender,date_format(start_date,'%d %M %Y') as tanggalmasuknya from human_pa_md_app_personal order by personnel_id asc");
