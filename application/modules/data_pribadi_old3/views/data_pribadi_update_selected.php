				                ...
				                <table class="table table-striped table-bordered">
				                    ...
				                    <tbody>
				                        ...
				                        <tr>
				                            ...
				                            <td>:</td>
				                            <td>
				                            	<input type="text" name="end_date" class="datepicker form-control" placeholder="End Date" value="<?php echo $end_date; ?>">
				                            </td>
				                        ...
				                        <tr>
				                            ...
				                            <td>:</td>
				                            <td> 
				                           		<input type="radio" value="1" name="gender" <?php if($gender == 1){ echo "checked=checked";}?> > Male &nbsp;
				                            	<input type="radio" value="2" name="gender" <?php if($gender == 2){ echo "checked=checked";}?>> Female
				                        ...
				                        <tr>
				                            ...
				                            <td>:</td>
				                            <td> 
				                            	<input type="text" name="birth_date" class="datepicker form-control" placeholder="Birthdate" value="<?php echo $birth_date; ?>">
				                             </td>
