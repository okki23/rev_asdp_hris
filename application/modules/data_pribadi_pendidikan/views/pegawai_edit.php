	...
	<!--awal bagian konten-->
 	...
 	<div class="page-container">
 	 	...
 	 	<div class="page-content">
        	...
        	<!-- Form components -->
    		<form class="form-horizontal" role="form" action="<?php echo base_url('pegawai/pro_update_pegawai');?>" method="POST">

    		 
				<!-- Basic inputs -->
		        <div class="panel panel-default">
			        <div class="panel-heading"><h6 class="panel-title"><i class="icon-bubble4"></i> Update Personal</h6></div>
	                <div class="panel-body">
						...
						<div class="form-group">
							...
							<div class="col-sm-10">
								<input type="text" name="nik" class="form-control" value="<?php echo $personnel_id;?>" readonly="readonly">
							</div>
						</div>
						...
						<div class="form-group">
							...
							<div class="col-sm-10">
								<input type="text" class="datepicker form-control" name="tanggal_masuk" placeholder="Tanggal Masuk" value="<?php echo $start_date;?>">
							</div>
						</div>
						...
						<div class="form-group">
							...
							<div class="col-sm-10">
								<input type="text" class="form-control" placeholder="Nama" name="nama"  value="<?php echo $name_full;?>">
							</div>
						</div>
