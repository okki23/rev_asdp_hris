...
$(document).ready(function(){
 ...
 <script type="text/javascript">
        $(document).ready(function () {
            var url = "<?php echo base_url('pegawai/get_all_pegawai_json');?>";
            // prepare the data
            var source =
            {
                dataType: "json",
            ...
            $("#dataTable").jqxDataTable(
            {
                ...
                columns: [
                  ...
                  { text: 'Full Name', dataField: 'name_full', cellsAlign: 'center', align: 'center', width: 580 },
                  { text: 'Tanggal Masuk', dataField: 'start_date', cellsAlign: 'center', align: 'center', width:150 },
                  { text: 'Update', dataField: 'opsiupdate',columngroup: 'Opsi', cellsAlign: 'center', align: 'center', width: 80 },
                  { text: 'Hapus', dataField: 'opsidelete',columngroup: 'Opsi', cellsAlign: 'center', align: 'center', width: 88 },
               
              ],
               columnGroups: 
                [
                  { text: 'Opsi', align: 'center', name: 'Opsi' }
	...
	<!--awal bagian konten-->
 	...
 	<div class="page-container">
			...
			<div class="sidebar-content">
				...
				<ul class="navigation">				
					<li  class="active" ><a href="<?php echo base_url('dashboard');?>"><span>Dashboard</span> <i class="icon-screen2"></i></a></li>
 	 	...
 	 	<div class="page-content">
			...
			<div class="page-header">
				...
				<div class="row">
				 <a href="<?php echo base_url('pegawai/add_pegawai'); ?>" class="btn btn-primary "> + Tambah Data </a>
				    	 <br>
				    	 &nbsp;
					...
					<div class="col-lg-12">
			            ...
			            <div class="panel panel-default">
			                ...
			                <div class="panel-heading"><h6 class="panel-title"> Tabel Data Pegawai </h6></div>
