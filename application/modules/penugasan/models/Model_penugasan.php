...
*/
	...
	public function penugasan_detail_pro_add($data){
		$sql = $this->db->query("insert into human_pa_md_emp_assignment (personnel_id,start_date,end_date,status_process,assignment_type,assignment_reason,employee_area,employee_office,employee_type,employee_subtype,position,organization,cost_center,company,unit,bagian,work_location,legal_letter_no,legal_date,legal_effective_date,remark) VALUES ('$data[personnel_id]','$data[start_date]','$data[end_date]','$data[status_process]','$data[assignment_type]','$data[assignment_reason]','$data[employee_area]','$data[employee_office]','$data[employee_type]','$data[employee_subtype]','$data[position]','$data[organization]','$data[cost_center]','$data[company]','$data[unit]','$data[bagian]','$data[work_location]','$data[legal_letter_no]','$data[legal_date]','$data[legal_effective_date]','$data[remark]')");
