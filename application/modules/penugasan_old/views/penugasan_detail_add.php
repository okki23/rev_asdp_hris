...
<div data-options="region:'west',split:false,hideCollapsedContent:false,singleSelect:true" collapsed="false" title="Add Penugasan" style="width:100%;">
        <?php
        ...
        <fieldset>
            ...
            <table>
                <tr>    
                    <td> Posisi </td>
                    <td colspan="2"> 
                        <input class="easyui-textbox"   type="text" name="position" ></input> 
                    </td>
                    <td> Organisasi </td>
                    <td colspan="2"> 
