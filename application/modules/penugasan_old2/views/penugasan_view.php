...
$(document).ready(function(){
 ...
 <script type="text/javascript">
        $(document).ready(function () {
            var url = "<?php echo base_url('penugasan/get_all_pic_penugasan_json');?>";
            // prepare the data
            var source =
            {
                dataType: "json",
            ...
            $("#dataTable").jqxDataTable(
            {
                ...
                columns: [
                  ...
                  { text: 'Full Name', dataField: 'name_full', cellsAlign: 'center', align: 'center', width: 650 },
                  { text: 'Tanggal Masuk', dataField: 'start_date', cellsAlign: 'center', align: 'center', width:150 },
                  { text: 'Opsi', dataField: 'opsidetail',cellsAlign: 'center', align: 'center', width: 90 }
				...
				<div class="row">
					...
					<div class="col-lg-12">
			            ...
			            <div class="panel panel-default">
			                ...
			                <div class="panel-heading"><h6 class="panel-title"> Tabel Penugasan </h6></div>
