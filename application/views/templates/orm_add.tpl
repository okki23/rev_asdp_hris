...
<link rel="stylesheet" type="text/css" href="{$link}assets/themes/default/easyui.css">
	...
	<script type="text/javascript" src="{$link}assets/jquery.easyui.min.js"></script>
		...
		<form action="{$link}orm/save" method="post" novalidate>
			...
			<div class="fitem" style="font-size:10px;">
				...
				<input name="code" value="{$kode}" data-options="prompt:'Code'" class="easyui-textbox" required="true"> - <input data-options="prompt:'Name'" name="name" class="easyui-textbox" required>
			</div>
			<div class="fitem" style="font-size:10px;">
			...
			<div class="fitem" style="font-size:10px;">
				...
				<input name="parentname" value="{$kode} - {$name}" class="easyui-textbox" readonly style="width:250px;">
				<input type=hidden name="parentcode" value="{$kode}">
